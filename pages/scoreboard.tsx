...
const Scoreboard: NextPage = () => {
	...
	const recoverLostGameData = () => {
		if (gameData && window.confirm('Recover lost game? #RIPBamse')) {
			setRounds(gameData.rounds);
			setCurrentRound(gameData.currentRound);
			setRoundBids(gameData.roundBids);
			setRoundGets(gameData.roundGets);
			setRoundScores(gameData.roundScores);
			setCumulativeScores(gameData.cumulativeScores);
			setBidsDone(gameData.bidsDone);
			setAddToLeaderboard(gameData.addToLeaderboard);
		}
	};
